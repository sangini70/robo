    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-12 border-b border-neutral-900 pb-6">
          <span className="text-xs uppercase tracking-[0.2em] text-neutral-500 font-medium block mb-3">Latest Updates</span>
          <h2 className="text-3xl md:text-4xl font-medium tracking-tight text-white">최신 글</h2>
        </div>
